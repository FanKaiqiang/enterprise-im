                    ...
                    <div ref='content'>
                        ...
                        <div>
                            ...
                            <label>
                                ...
                                <span className="radio_span">公开</span>
                            </label>
                            <label>
                                <input className="radio" type="radio" value="option2"
                                       checked={this.state.selectedOption === 'option2'}
                                       onChange={this.handleOptionChange}/>
                                <span className="radio_span">私密</span>
                            </label>
                        </div>
                        <div className={this.state.selectedOption === 'option1' ? '' : 'hide'}>
                            ...
                            <label>
                                ...
                                <span
                                    className="radio_span">{this.state.selectedOption === 'option1' ? '需要审批' : '不允许邀请'}</span>
                            </label>
                            <label>
                                <input className="radio" type="radio" value="option4"
                                       ...
                                       onChange={this.handleOptionChange2}/>
                                <span
                                    className="radio_span">{this.state.selectedOption === 'option1' ? '无需审批' : '允许'}</span>
                            </label>
                        </div>
                        <div className={this.state.selectedOption === 'option1' ? 'hide' : ''}>
                            <label>
