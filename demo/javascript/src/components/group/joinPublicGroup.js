                ...
                <div className='webim-dialog'>
                    ...
                    <div className="webim-dialog-body" onScroll={this.onScroll} ref='groupList'>
                        ...
                        <div className={!this.state.groupDetail ? "hide" : "webim-dialog-body-detail"}>
                            <span className="title">会议名称</span>
                            <span className="content">{this.state.groupName || '[会议名称未设置]'}</span>
                        </div>
                        <div className={!this.state.groupDetail ? "hide" : "webim-dialog-body-detail"}>
                            <span className="title">会议发起人</span>
                            <span className="content">{this.state.owner || '[会议发起人未设置]'}</span>
                        </div>
                        <div className={!this.state.groupDetail ? "hide" : "webim-dialog-body-detail"}>
                            <span className="title">会议简介</span>
                            <span className="content">{this.state.description || '[会议简介未设置]'}</span>
                        </div>
                        <div className={!this.state.groupDetail ? "hide" : "webim-dialog-body-detail"}>
                            <span className="title">加入会议是否需要审批</span>
