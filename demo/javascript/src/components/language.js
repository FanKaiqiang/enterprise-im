...
exports.Chinese = {
    ...
    noaccount: '没有账号',
    signupnow: '现在注册',
    joinPublicGroup: '申请加入工作小组',
    createGroup: '发起工作小组',
    chooseGroupMember: '选择成员',
    selectedLabel: "选中",
    groupMemberLabel: "所有成员",
    groupSubject: '工作小组名',
    groupDescription: '工作小组简介',
    groupPermission: '小组类型',
    groupMemberPermission: '成员权限',
    adminGroupMembers: '管理工作小组成员',
    inviteGroupMembers: '邀请新成员',
    changeGroupSubject: '修改工作小组名称',
    changeGroupDescription: '修改工作小组简介',
    destroyGroup: '解散工作小组',
    leaveGroup: '退出工作小组',
    shield: '消息免打扰',
    receive: '接受消息',
    ...
    ShowBlacklist: '好友黑名单',
    // button
    groupBlacklist: '工作小组黑名单',
    // title
    showGroupBlacklist: '工作小组黑名单',
    memberInvite: '邀请好友',
    changeGroupInfo: '修改工作小组信息',
    groupNotification: '工作小组消息',
    fileOverSize: '文件最大不能超过10MB',
    deletePrivateGroupMember: '权限不够，不能删除此工作小组成员',
    groupNameNotEmpty: '工作小组名不能为空',
    refuse: '%s拒绝了你的请求',
    inviteToGroup: '%s邀请您加入工作小组',
    inviteGroup: '您邀请了%s加入工作小组',
    createGroupSuc: '已成功建立工作小组%s',
    logoutSuc: '您已下线',
    onMuted: '您已被禁言',
    search: '搜索',
    join: '加入工作小组',
    addToGroupBlackList: '加入工作小组黑名单',
    mute: '禁言',
    removeMute: '解除禁言',
    administrator: '设为管理人员',
    rmAdministrator: '移除管理人员',
    removeGroupMember: '从此工作小组中移除',
    addGroupMember: '添加工作小组成员',
    allowInvite: '允许邀请加入工作小组',
    last: ''
};
