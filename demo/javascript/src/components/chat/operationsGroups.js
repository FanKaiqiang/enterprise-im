        ...
        if (WebIM.config.isWindowSDK) {
            ...
            var options = {
                ...
                success: function (respData) {
                    Demo.api.NotifySuccess(`你将id为 ${groupId}的多人会议解散了`);
                    Demo.api.updateGroup();
                },
        ...
        if (WebIM.config.isWindowSDK) {
            ...
            var options = {
                ...
                success: function () {
                    ...
                    Demo.api.NotifySuccess("你已经离开了会议" + groupId);
                },
                error: function (code, msg) {
                    Demo.api.NotifyError("leaveGroup:" + code + " " + msg);
                }
    ...
    render: function () {//工作小组管理悬浮菜单组件渲染
        ...
        return (<div>
                ...
                <ul tabIndex="-1" ref="webim-operations" 
                    ...
                    <li onClick={this.adminGroupMembers} className={this.state.admin ? '' : 'hide'}>
                    ...
                    <li onClick={this.changeGroupInfo} className={this.state.admin ? '' : 'hide'}>
                        <i className='font smallest'>B</i>
                        <span>{"修改工作小组信息"}</span >
                    </li>
                    <li onClick={this.showGroupBlacklist} className={this.state.admin ? '' : 'hide'}>
